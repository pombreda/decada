...
ID_DECA_EMPTY = wx.NewId()
ID_DECA_ENGINE = wx.NewId()
ID_DECA_FILTER = wx.NewId()
ID_DECA_IMAGES = wx.NewId()
ID_DECA_LAYER = wx.NewId()
ID_DECA_LAYOUT = wx.NewId()
ID_DECA_LINK = wx.NewId()
ID_DECA_OBJECT = wx.NewId()
ID_DECA_PUSH = wx.NewId()
ID_DECA_PULL = wx.NewId()
ID_DECA_REPORT = wx.NewId()
ID_DECA_REPOSITORY = wx.NewId()
ID_DECA_TOOLS = wx.NewId()
ID_DECA_WORLD = wx.NewId()

ID_DECA_REGEX = wx.NewId()
ID_DECA_CASE = wx.NewId()
ID_DECA_WORD = wx.NewId()
